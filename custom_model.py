...
# --------------------------------------------------------------------------------------------------------------------------------------------
# ------------------------------------ This class for the Model is designed for the Fashion-MNIST dataset ------------------------------------
# --------------------------------------------------------------------------------------------------------------------------------------------
...
class MPScrModel(MPScrModelStructure):
    ...
    def define_structure(self, shape_input, seed = 1):
        ...
        self.dense1 = keras.layers.Dense(units = 64, activation = tf.nn.tanh, dtype = tf.float32)
    ...
    def build_graph(self):
        # x = keras.layers.Input(shape = self.shape_input)
