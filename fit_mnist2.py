...
if(__name__ == "__main__"):
    ...
    for dist in dists_scenario1:
        for j in range(1,101):
            Path("SimulationResults2/Scenario1/n500/{}/{}".format(dist,j)).mkdir(parents=True, exist_ok=True)
            Path("SimulationResults2/Scenario1/n1000/{}/{}".format(dist,j)).mkdir(parents=True, exist_ok=True)
            Path("SimulationResults2/Scenario1/n3000/{}/{}".format(dist,j)).mkdir(parents=True, exist_ok=True)
    for dist in dists_scenario2:
        for j in range(1,101):
            Path("SimulationResults2/Scenario2/n500/{}/{}".format(dist,j)).mkdir(parents=True, exist_ok=True)
    ...
    data_dir = ["SimulationDataset2/Scenario2/n500", "SimulationDataset2/Scenario2/n1000", "SimulationDataset2/Scenario2/n3000"]
    distributions = ["rgp2", "rgp2", "rgp2"]
    qs = [2.0, 2.0, 2.0]
